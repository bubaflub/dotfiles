...
syn keyword pirOp set_label get_label fetch close fdopen getstdin
syn keyword pirOp getstdout getstderr setstdin setstdout setstderr open
syn keyword pirOp print say printerr read readline peek stat seek tell
syn keyword pirOp abs add cmod dec div fdiv ceil floor inc mod mul neg
syn keyword pirOp pow sub sqrt acos asec asin atan cos cosh exp ln log10
syn keyword pirOp log2 sec sech sin sinh tan tanh gcd lcm fact
...
syn keyword pirOp getattribute setattribute inspect new root_new typeof
...
syn keyword pirOp sysinfo sleep sizeof store_lex store_dynamic_lex
syn keyword pirOp find_lex find_dynamic_lex find_caller_lex get_namespace
